  ...
  const handleActivation = async () => {
    ...
    try {
      ...
      if (error || !data || !data[0]?.success) {
        ...
        await AsyncStorage.setItem('@activated_license', licenseKey.trim());
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.form}>
            ...
            <TouchableOpacity disabled={loading} style={styles.btnSkip} onPress={handleFreeAccess}><Text style={styles.skipText}>Explore Free Access</Text></TouchableOpacity>
